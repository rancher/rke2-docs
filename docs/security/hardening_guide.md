...
2. Sets the etcd user and group to the static etcd pod as explained in the [etcd section](https://docs.rke2.io/security/hardening_guide#etcd-is-configured-properly)

3. Applies network policies that allow the cluster to pass associated controls.

4. Apply more restrictive file permissions (600 vs 644) to agent manifests and other configurations files. 
