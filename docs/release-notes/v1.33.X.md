...
## Release [v1.33.13+rke2r2](https://github.com/rancher/rke2/releases/tag/v1.33.13+rke2r2)
<!-- v1.33.13+rke2r2 -->
...
* Bump HCP 0.2.12 [(#10646)](https://github.com/rancher/rke2/pull/10646)
* Update build-images to use `PULL_CMD` instead of `docker pull` [(#10679)](https://github.com/rancher/rke2/pull/10679)
* Charts: Bump Harvester CSI driver 0.1.30 [(#10666)](https://github.com/rancher/rke2/pull/10666)
* Update ingress-nginx to chart 4.15.102 / image v1.15.1-prime5 [(#10700)](https://github.com/rancher/rke2/pull/10700)
* Bump hardened runtime images for Go/x-net CVE fixes [(#10728)](https://github.com/rancher/rke2/pull/10728)
* Backport chart updates to release-1.33: canal, calico, cilium, multus… [(#10740)](https://github.com/rancher/rke2/pull/10740)
* Bump HCP to 0.2.14 [(#10705)](https://github.com/rancher/rke2/pull/10705)
* Bump klipper-helm to v0.12.1-build20260709 [(#10748)](https://github.com/rancher/rke2/pull/10748)
* Bump snapshot-controller image tag to v8.6.0-build20260708 [(#10758)](https://github.com/rancher/rke2/pull/10758)
* Update to coredns chart 1.46.004 and metrics-server chart 3.13.102 [(#10765)](https://github.com/rancher/rke2/pull/10765)
* Update ingress-nginx to chart 4.15.103 / image v1.15.1-prime6 [(#10769)](https://github.com/rancher/rke2/pull/10769)
* Bump Traefik v3.7.7 [(#10777)](https://github.com/rancher/rke2/pull/10777)
* Update Multus chart to v4.3.004 [(#10784)](https://github.com/rancher/rke2/pull/10784)
* Bump etcd to 3.6.12-k3s1-build20260708 [(#10790)](https://github.com/rancher/rke2/pull/10790)
* Bump ccm - 2026 July [(#10798)](https://github.com/rancher/rke2/pull/10798)
* Add PRIME versions of the vsphere images [(#10793)](https://github.com/rancher/rke2/pull/10793)
* Bump k3s for 2026-07 [(#10803)](https://github.com/rancher/rke2/pull/10803)
* Bump ingress-nginx version to prime7 [(#10818)](https://github.com/rancher/rke2/pull/10818)
* Update Canal chart to v3.32.1-build2026070901 [(#10827)](https://github.com/rancher/rke2/pull/10827)
* Update to coredns chart 1.46.1 and metrics-server chart 3.13.1 [(#10840)](https://github.com/rancher/rke2/pull/10840)
    * Update CNIs for 2026-07 Release Cycle [(#10855)](https://github.com/rancher/rke2/pull/10855)
* Bump Traefik to v3.7.8 [(#10864)](https://github.com/rancher/rke2/pull/10864)
* Bump k3s again for 2026-07 [(#10846)](https://github.com/rancher/rke2/pull/10846)
* Chore: Update rke2-ingress-nginx version in charts/chart_versions.yaml [(#10875)](https://github.com/rancher/rke2/pull/10875)
* Bump helm-controller and klipper-helm for --force-conflicts support [(#10894)](https://github.com/rancher/rke2/pull/10894)
* Don't clean up data dirs still referenced by containers [(#10898)](https://github.com/rancher/rke2/pull/10898)
    * Update CNIs for 2026-07 Release Cycle [(#10904)](https://github.com/rancher/rke2/pull/10904)
* Update to v1.33.13-rke2r2 and Go 1.25.11 [(#10915)](https://github.com/rancher/rke2/pull/10915)
* Bump hardened images to build20260722 for grpc CVE (GHSA-hrxh-6v49-42gf) [(#10911)](https://github.com/rancher/rke2/pull/10911)
* Update vsphere-csi chart (#10912) [(#10934)](https://github.com/rancher/rke2/pull/10934)
* Fix package-windows-images platform matching [(#10938)](https://github.com/rancher/rke2/pull/10938)
* Validate-charts: validate vsphere prime (hardened) images [(#10930)](https://github.com/rancher/rke2/pull/10930)
* Bump hardened-crictl to v1.33.0-build20260727 [(#10950)](https://github.com/rancher/rke2/pull/10950)
* Bump helm-controller and klipper-helm [(#10961)](https://github.com/rancher/rke2/pull/10961)
* Bump containerd to v2.2.6-k3s1 [(#10966)](https://github.com/rancher/rke2/pull/10966)
* Bump ingress-nginx chart and version [(#10970)](https://github.com/rancher/rke2/pull/10970)
* Bump vSphere CSI chart to 3.7.2-rancher500 and hardened-csi-provisioner to v4.0.1-build20260730 [(#10979)](https://github.com/rancher/rke2/pull/10979)
* Update rancher-vsphere-csi to 3.7.2-rancher600 and align hardened CSI images [(#10987)](https://github.com/rancher/rke2/pull/10987)
