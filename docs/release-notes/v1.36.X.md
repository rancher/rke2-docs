...
## Release [v1.36.4+rke2r1](https://github.com/rancher/rke2/releases/tag/v1.36.4+rke2r1)
<!-- v1.36.4+rke2r1 -->
...
* Bump rke2-traefik to 41.1.101 - #11002 [(#11006)](https://github.com/rancher/rke2/pull/11006)
* Chore: bump rke2-canal, rke2-flannel [(#11015)](https://github.com/rancher/rke2/pull/11015)
* Bump rke2-metrics-server to 3.13.106 [(#11027)](https://github.com/rancher/rke2/pull/11027)
* Fix windows airgap by refactoring rke2-runtime image build+bundle pipeline [(#11031)](https://github.com/rancher/rke2/pull/11031)
* Charts: Bump Harvester CSI driver 0.1.31 [(#11037)](https://github.com/rancher/rke2/pull/11037)
* Bump HCP 0.2.15 [(#11045)](https://github.com/rancher/rke2/pull/11045)
* Bump containerd to v2.3.4-k3s1.36 [(#11062)](https://github.com/rancher/rke2/pull/11062)
* Bump etcd, crictl, runc and containerd [(#11075)](https://github.com/rancher/rke2/pull/11075)
* Bump klipper-helm to v0.13.3-build20260820 [(#11089)](https://github.com/rancher/rke2/pull/11089)
* Bumps to runtime images, coredns, k8s metrics server, ingress-nginx, and traefik [(#11096)](https://github.com/rancher/rke2/pull/11096)
  - Update CNIs for 2026-08 Release Cycle [(#11097)](https://github.com/rancher/rke2/pull/11097)
* Bump K3s and CCM for 2026-08 release cycle [(#11071)](https://github.com/rancher/rke2/pull/11071)
* Update to v1.36.4-rke2r1 and Go 1.26.5 [(#11106)](https://github.com/rancher/rke2/pull/11106)
* Fix 'no such image' in Release CI [(#11113)](https://github.com/rancher/rke2/pull/11113)
* Use rke2-traefik-1.34-1.36 [(#11124)](https://github.com/rancher/rke2/pull/11124)
  - Update Canal chart to v3.32.1-build2026082700 [(#11132)](https://github.com/rancher/rke2/pull/11132)
...
## Release [v1.36.3+rke2r1](https://github.com/rancher/rke2/releases/tag/v1.36.3+rke2r1)
<!-- v1.36.3+rke2r1 -->
...
* Bump HCP 0.2.12 [(#10644)](https://github.com/rancher/rke2/pull/10644)
* Charts: Bump Harvester CSI driver 0.1.30 [(#10670)](https://github.com/rancher/rke2/pull/10670)
* Update ingress-nginx to chart 4.15.102 / image v1.15.1-prime5 [(#10697)](https://github.com/rancher/rke2/pull/10697)
* Bump hardened runtime images for Go/x-net CVE fixes [(#10725)](https://github.com/rancher/rke2/pull/10725)
* Backport chart updates to release-1.36: canal, calico, cilium, multus… [(#10741)](https://github.com/rancher/rke2/pull/10741)
* Bump HCP to 0.2.14 [(#10702)](https://github.com/rancher/rke2/pull/10702)
* Bump klipper-helm to v0.12.1-build20260709 [(#10751)](https://github.com/rancher/rke2/pull/10751)
* Bump snapshot-controller image tag to v8.6.0-build20260708 [(#10755)](https://github.com/rancher/rke2/pull/10755)
* Update to coredns chart 1.46.004 and metrics-server chart 3.13.102 [(#10762)](https://github.com/rancher/rke2/pull/10762)
* Update ingress-nginx to chart 4.15.103 / image v1.15.1-prime6 [(#10766)](https://github.com/rancher/rke2/pull/10766)
* Bump Traefik to v3.7.7 [(#10771)](https://github.com/rancher/rke2/pull/10771)
* Update Multus chart to v4.3.004 [(#10781)](https://github.com/rancher/rke2/pull/10781)
* Bump CCM - 2026 July [(#10795)](https://github.com/rancher/rke2/pull/10795)
* Bump etcd to 3.6.12-k3s1-build20260708 [(#10787)](https://github.com/rancher/rke2/pull/10787)
* Add PRIME versions of the vsphere images [(#10794)](https://github.com/rancher/rke2/pull/10794)
* Bump k3s for 2026-07 [(#10800)](https://github.com/rancher/rke2/pull/10800)
* Bump ingress-nginx version to prime7 [(#10816)](https://github.com/rancher/rke2/pull/10816)
* Update Canal chart to v3.32.1-build2026070901 [(#10824)](https://github.com/rancher/rke2/pull/10824)
* Update to coredns chart 1.46.1 and metrics-server chart 3.13.1 [(#10837)](https://github.com/rancher/rke2/pull/10837)
* Update CNIs for 2026-07 Release Cycle [(#10852)](https://github.com/rancher/rke2/pull/10852)
* Bump Traefik to v3.7.8 [(#10857)](https://github.com/rancher/rke2/pull/10857)
* Bump k3s again for 2026-07 [(#10842)](https://github.com/rancher/rke2/pull/10842)
* Chore: Update rke2-ingress-nginx version in charts/chart_versions.yaml [(#10872)](https://github.com/rancher/rke2/pull/10872)
* Bump helm-controller and klipper-helm for --force-conflicts support [(#10891)](https://github.com/rancher/rke2/pull/10891)
* Don't clean up data dirs still referenced by containers [(#10895)](https://github.com/rancher/rke2/pull/10895)
* Update CNIs for 2026-07 Release Cycle [(#10901)](https://github.com/rancher/rke2/pull/10901)
* Update to v1.36.3-rke2r1 and Go 1.26.5 [(#10918)](https://github.com/rancher/rke2/pull/10918)
* Bump hardened images to build20260722 for grpc CVE (GHSA-hrxh-6v49-42gf) [(#10908)](https://github.com/rancher/rke2/pull/10908)
* Update vsphere-csi chart (#10912) [(#10931)](https://github.com/rancher/rke2/pull/10931)
* Fix package-windows-images platform matching [(#10941)](https://github.com/rancher/rke2/pull/10941)
* Validate-charts: validate vsphere prime (hardened) images [(#10922)](https://github.com/rancher/rke2/pull/10922)
* Bump hardened-crictl to v1.36.0-build20260727 [(#10953)](https://github.com/rancher/rke2/pull/10953)
* Bump helm-controller and klipper-helm [(#10958)](https://github.com/rancher/rke2/pull/10958)
* Bump containerd to v2.3.3-k3s1 [(#10963)](https://github.com/rancher/rke2/pull/10963)
* Bump ingress-nginx chart and version [(#10967)](https://github.com/rancher/rke2/pull/10967)
* Bump vSphere CSI chart to 3.7.2-rancher500 and hardened-csi-provisioner to v4.0.1-build20260730 [(#10976)](https://github.com/rancher/rke2/pull/10976)
* Update rancher-vsphere-csi to 3.7.2-rancher600 and align hardened CSI images [(#10984)](https://github.com/rancher/rke2/pull/10984)
