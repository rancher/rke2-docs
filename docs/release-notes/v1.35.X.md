...
## Release [v1.35.8+rke2r1](https://github.com/rancher/rke2/releases/tag/v1.35.8+rke2r1)
<!-- v1.35.8+rke2r1 -->
...
* Chore: bump rke2-canal, rke2-flannel [(#11017)](https://github.com/rancher/rke2/pull/11017)
* Bump rke2-metrics-server to 3.13.106 [(#11025)](https://github.com/rancher/rke2/pull/11025)
* Fix windows airgap by refactoring rke2-runtime image build+bundle pipeline [(#11032)](https://github.com/rancher/rke2/pull/11032)
* Charts: Bump Harvester CSI driver 0.1.31 [(#11036)](https://github.com/rancher/rke2/pull/11036)
* Bump HCP 0.2.15 [(#11044)](https://github.com/rancher/rke2/pull/11044)
* Bump containerd to v2.2.7-k3s1 [(#11065)](https://github.com/rancher/rke2/pull/11065)
* Bump etcd, crictl, runc and containerd [(#11076)](https://github.com/rancher/rke2/pull/11076)
* Bump klipper-helm to v0.13.3-build20260820 [(#11090)](https://github.com/rancher/rke2/pull/11090)
  - Update CNIs for 2026-08 Release Cycle [(#11098)](https://github.com/rancher/rke2/pull/11098)
* Bumps to runtime images, coredns, k8s metrics server, ingress-nginx, and traefik [(#11094)](https://github.com/rancher/rke2/pull/11094)
* Bump K3s and CCM for 2026-08 release cycle [(#11072)](https://github.com/rancher/rke2/pull/11072)
* Update to v1.35.8-rke2r1 and Go 1.26.5 [(#11105)](https://github.com/rancher/rke2/pull/11105)
* Fix 'no such image' in Release CI [(#11112)](https://github.com/rancher/rke2/pull/11112)
* Use rke2-traefik-1.34-1.36 [(#11125)](https://github.com/rancher/rke2/pull/11125)
  - Update Canal chart to v3.32.1-build2026082700 [(#11133)](https://github.com/rancher/rke2/pull/11133)
...
## Release [v1.35.7+rke2r1](https://github.com/rancher/rke2/releases/tag/v1.35.7+rke2r1)
<!-- v1.35.7+rke2r1 -->
...
* Bump HCP 0.2.12 [(#10643)](https://github.com/rancher/rke2/pull/10643)
* Charts: Bump Harvester CSI driver 0.1.30 [(#10669)](https://github.com/rancher/rke2/pull/10669)
* Update ingress-nginx to chart 4.15.102 / image v1.15.1-prime5 [(#10698)](https://github.com/rancher/rke2/pull/10698)
* Bump hardened runtime images for Go/x-net CVE fixes [(#10726)](https://github.com/rancher/rke2/pull/10726)
* Backport chart updates to release-1.35: canal, calico, cilium, multus… [(#10738)](https://github.com/rancher/rke2/pull/10738)
* Bump HCP to 0.2.14 [(#10703)](https://github.com/rancher/rke2/pull/10703)
* Bump klipper-helm to v0.12.1-build20260709 [(#10750)](https://github.com/rancher/rke2/pull/10750)
* Bump snapshot-controller image tag to v8.6.0-build20260708 [(#10756)](https://github.com/rancher/rke2/pull/10756)
* Update to coredns chart 1.46.004 and metrics-server chart 3.13.102 [(#10763)](https://github.com/rancher/rke2/pull/10763)
* Bump Traefik v3.7.7 [(#10773)](https://github.com/rancher/rke2/pull/10773)
* Update ingress-nginx to chart 4.15.103 / image v1.15.1-prime6 [(#10767)](https://github.com/rancher/rke2/pull/10767)
* Update Multus chart to v4.3.004 [(#10782)](https://github.com/rancher/rke2/pull/10782)
* Bump etcd to 3.6.12-k3s1-build20260708 [(#10788)](https://github.com/rancher/rke2/pull/10788)
* Bump ccm - 2026 July [(#10796)](https://github.com/rancher/rke2/pull/10796)
* Add PRIME versions of the vsphere images [(#10791)](https://github.com/rancher/rke2/pull/10791)
* Bump k3s for 2026-07 [(#10801)](https://github.com/rancher/rke2/pull/10801)
* Bump ingress-nginx version to prime7 [(#10817)](https://github.com/rancher/rke2/pull/10817)
* Update Canal chart to v3.32.1-build2026070901 [(#10825)](https://github.com/rancher/rke2/pull/10825)
* Update to coredns chart 1.46.1 and metrics-server chart 3.13.1 [(#10838)](https://github.com/rancher/rke2/pull/10838)
    * Update CNIs for 2026-07 Release Cycle [(#10853)](https://github.com/rancher/rke2/pull/10853)
* Bump Traefik to v3.7.8 [(#10859)](https://github.com/rancher/rke2/pull/10859)
* Bump k3s again for 2026-07 [(#10843)](https://github.com/rancher/rke2/pull/10843)
* Chore: Update rke2-ingress-nginx version in charts/chart_versions.yaml [(#10873)](https://github.com/rancher/rke2/pull/10873)
* Bump helm-controller and klipper-helm for --force-conflicts support [(#10892)](https://github.com/rancher/rke2/pull/10892)
* Don't clean up data dirs still referenced by containers [(#10896)](https://github.com/rancher/rke2/pull/10896)
    * Update CNIs for 2026-07 Release Cycle [(#10902)](https://github.com/rancher/rke2/pull/10902)
* Update to v1.35.7-rke2r1 and Go 1.25.12 [(#10917)](https://github.com/rancher/rke2/pull/10917)
* Bump hardened images to build20260722 for grpc CVE (GHSA-hrxh-6v49-42gf) [(#10909)](https://github.com/rancher/rke2/pull/10909)
* Update vsphere-csi chart (#10912) [(#10932)](https://github.com/rancher/rke2/pull/10932)
* Fix package-windows-images platform matching [(#10940)](https://github.com/rancher/rke2/pull/10940)
* Validate-charts: validate vsphere prime (hardened) images [(#10923)](https://github.com/rancher/rke2/pull/10923)
* Bump hardened-crictl to v1.35.0-build20260727 [(#10952)](https://github.com/rancher/rke2/pull/10952)
* Bump helm-controller and klipper-helm [(#10959)](https://github.com/rancher/rke2/pull/10959)
* Bump containerd to v2.2.6-k3s1 [(#10964)](https://github.com/rancher/rke2/pull/10964)
* Bump ingress-nginx chart and version [(#10968)](https://github.com/rancher/rke2/pull/10968)
* Bump vSphere CSI chart to 3.7.2-rancher500 and hardened-csi-provisioner to v4.0.1-build20260730 [(#10977)](https://github.com/rancher/rke2/pull/10977)
* Update rancher-vsphere-csi to 3.7.2-rancher600 and align hardened CSI images [(#10985)](https://github.com/rancher/rke2/pull/10985)
