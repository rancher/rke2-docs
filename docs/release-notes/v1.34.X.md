...
## Release [v1.34.11+rke2r1](https://github.com/rancher/rke2/releases/tag/v1.34.11+rke2r1)
<!-- v1.34.11+rke2r1 -->
...
* Chore: bump rke2-canal, rke2-flannel [(#11019)](https://github.com/rancher/rke2/pull/11019)
* Bump rke2-metrics-server to 3.13.106 [(#11023)](https://github.com/rancher/rke2/pull/11023)
* Fix windows airgap by refactoring rke2-runtime image build+bundle pipeline [(#11033)](https://github.com/rancher/rke2/pull/11033)
* Charts: Bump Harvester CSI driver 0.1.31 [(#11035)](https://github.com/rancher/rke2/pull/11035)
* Bump HCP 0.2.15 [(#11042)](https://github.com/rancher/rke2/pull/11042)
* Bump containerd to v2.2.7-k3s1 [(#11063)](https://github.com/rancher/rke2/pull/11063)
* Bump etcd, crictl, runc and containerd [(#11077)](https://github.com/rancher/rke2/pull/11077)
* Bump klipper-helm to v0.13.3-build20260820 [(#11091)](https://github.com/rancher/rke2/pull/11091)
* Bumps to runtime images, coredns, k8s metrics server, ingress-nginx, and traefik [(#11095)](https://github.com/rancher/rke2/pull/11095)
  - Update CNIs for 2026-08 Release Cycle [(#11099)](https://github.com/rancher/rke2/pull/11099)
* Bump K3s and CCM for 2026-08 release cycle [(#11073)](https://github.com/rancher/rke2/pull/11073)
* Update to v1.34.11-rke2r1 and Go 1.26.5 [(#11104)](https://github.com/rancher/rke2/pull/11104)
* Fix 'no such image' in Release CI [(#11111)](https://github.com/rancher/rke2/pull/11111)
* Ensure correct containerd socket address [(#11121)](https://github.com/rancher/rke2/pull/11121)
* Fix `release.yml` syntax [(#11122)](https://github.com/rancher/rke2/pull/11122)
* Update image pull command to run per image [(#11123)](https://github.com/rancher/rke2/pull/11123)
* Use rke2-traefik-1.34-1.36 [(#11126)](https://github.com/rancher/rke2/pull/11126)
  - Update Canal chart to v3.32.1-build2026082700 [(#11134)](https://github.com/rancher/rke2/pull/11134)


## Charts Versions
| Component | Version |
| --- | --- |
| rke2-cilium | [1.19.601](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-cilium/rke2-cilium-1.19.601.tgz) |
| rke2-canal | [v3.32.1-build2026082700](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-canal/rke2-canal-v3.32.1-build2026082700.tgz) |
| rke2-calico | [v3.32.100](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-calico/rke2-calico-v3.32.100.tgz) |
| rke2-calico-crd | [v3.32.100](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-calico/rke2-calico-crd-v3.32.100.tgz) |
| rke2-coredns | [1.47.003](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-coredns/rke2-coredns-1.47.003.tgz) |
| rke2-ingress-nginx | [4.15.109](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-ingress-nginx/rke2-ingress-nginx-4.15.109.tgz) |
| rke2-metrics-server | [3.14.000](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-metrics-server/rke2-metrics-server-3.14.000.tgz) |
| rke2-multus | [v4.3.008](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-traefik/rke2-multus-v4.3.008.tgz) |
| rancher-vsphere-csi | [3.7.2-rancher700](https://github.com/rancher/rke2-charts/raw/main/assets/rancher-vsphere-csi/rancher-vsphere-csi-3.7.2-rancher700.tgz) |
| rancher-vsphere-cpi | [1.15.300](https://github.com/rancher/rke2-charts/raw/main/assets/rancher-vsphere-cpi/rancher-vsphere-cpi-1.15.300.tgz) |
| harvester-cloud-provider | [0.2.1500](https://github.com/rancher/rke2-charts/raw/main/assets/harvester-cloud-provider/harvester-cloud-provider-0.2.1500.tgz) |
| harvester-csi-driver | [0.1.3100](https://github.com/rancher/rke2-charts/raw/main/assets/harvester-cloud-provider/harvester-csi-driver-0.1.3100.tgz) |
| rke2-snapshot-controller | [5.2.003](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-snapshot-controller/rke2-snapshot-controller-5.2.003.tgz) |
| rke2-snapshot-controller-crd | [5.2.003](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-snapshot-controller/rke2-snapshot-controller-crd-5.2.003.tgz) |
| rke2-traefik | [40.1.010](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-traefik/rke2-traefik-40.1.010.tgz) |
| rke2-traefik-crd | [40.1.010](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-traefik/rke2-traefik-crd-40.1.010.tgz) |


-----

## Release [v1.34.10+rke2r1](https://github.com/rancher/rke2/releases/tag/v1.34.10+rke2r1)
<!-- v1.34.10+rke2r1 -->
...
* Bump HCP 0.2.12 [(#10645)](https://github.com/rancher/rke2/pull/10645)
* Charts: Bump Harvester CSI driver 0.1.30 [(#10668)](https://github.com/rancher/rke2/pull/10668)
* Update ingress-nginx to chart 4.15.102 / image v1.15.1-prime5 [(#10699)](https://github.com/rancher/rke2/pull/10699)
* Bump hardened runtime images for Go/x-net CVE fixes [(#10727)](https://github.com/rancher/rke2/pull/10727)
* Backport chart updates to release-1.34: canal, calico, cilium, multus… [(#10739)](https://github.com/rancher/rke2/pull/10739)
* Bump HCP to 0.2.14 [(#10704)](https://github.com/rancher/rke2/pull/10704)
* Bump klipper-helm to v0.12.1-build20260709 [(#10749)](https://github.com/rancher/rke2/pull/10749)
* Bump snapshot-controller image tag to v8.6.0-build20260708 [(#10757)](https://github.com/rancher/rke2/pull/10757)
* Update to coredns chart 1.46.004 and metrics-server chart 3.13.102 [(#10764)](https://github.com/rancher/rke2/pull/10764)
* Update ingress-nginx to chart 4.15.103 / image v1.15.1-prime6 [(#10768)](https://github.com/rancher/rke2/pull/10768)
* Bump Traefik v3.7.7 [(#10776)](https://github.com/rancher/rke2/pull/10776)
* Update Multus chart to v4.3.004 [(#10783)](https://github.com/rancher/rke2/pull/10783)
* Bump etcd to 3.6.12-k3s1-build20260708 [(#10789)](https://github.com/rancher/rke2/pull/10789)
* Bump ccm - 2026 July [(#10797)](https://github.com/rancher/rke2/pull/10797)
* Add PRIME versions of the vsphere images [(#10792)](https://github.com/rancher/rke2/pull/10792)
* Bump k3s for 2026-07 [(#10802)](https://github.com/rancher/rke2/pull/10802)
* Bump ingress-nginx version to prime7 [(#10815)](https://github.com/rancher/rke2/pull/10815)
* Update Canal chart to v3.32.1-build2026070901 [(#10826)](https://github.com/rancher/rke2/pull/10826)
* Update to coredns chart 1.46.1 and metrics-server chart 3.13.1 [(#10839)](https://github.com/rancher/rke2/pull/10839)
    * Update CNIs for 2026-07 Release Cycle [(#10854)](https://github.com/rancher/rke2/pull/10854)
* Bump Traefik to v3.7.8 [(#10863)](https://github.com/rancher/rke2/pull/10863)
* Bump k3s again for 2026-07 [(#10844)](https://github.com/rancher/rke2/pull/10844)
* Chore: Update rke2-ingress-nginx version in charts/chart_versions.yaml [(#10874)](https://github.com/rancher/rke2/pull/10874)
* Bump helm-controller and klipper-helm for --force-conflicts support [(#10893)](https://github.com/rancher/rke2/pull/10893)
* Don't clean up data dirs still referenced by containers [(#10897)](https://github.com/rancher/rke2/pull/10897)
    * Update CNIs for 2026-07 Release Cycle [(#10903)](https://github.com/rancher/rke2/pull/10903)
* Update to v1.34.10-rke2r1 and Go 1.25.12 [(#10916)](https://github.com/rancher/rke2/pull/10916)
* Bump hardened images to build20260722 for grpc CVE (GHSA-hrxh-6v49-42gf) [(#10910)](https://github.com/rancher/rke2/pull/10910)
* Update vsphere-csi chart (#10912) [(#10933)](https://github.com/rancher/rke2/pull/10933)
* Fix package-windows-images platform matching [(#10939)](https://github.com/rancher/rke2/pull/10939)
* Validate-charts: validate vsphere prime (hardened) images [(#10924)](https://github.com/rancher/rke2/pull/10924)
* Bump hardened-crictl to v1.34.0-build20260727 [(#10951)](https://github.com/rancher/rke2/pull/10951)
* Bump helm-controller and klipper-helm [(#10960)](https://github.com/rancher/rke2/pull/10960)
* Bump containerd to v2.2.6-k3s1 [(#10965)](https://github.com/rancher/rke2/pull/10965)
* Bump vSphere CSI chart to 3.7.2-rancher500 and hardened-csi-provisioner to v4.0.1-build20260730 [(#10978)](https://github.com/rancher/rke2/pull/10978)
* Bump ingress-nginx chart and version [(#10969)](https://github.com/rancher/rke2/pull/10969)
* Update rancher-vsphere-csi to 3.7.2-rancher600 and align hardened CSI images [(#10986)](https://github.com/rancher/rke2/pull/10986)
...
| --- | --- |
| rke2-cilium | [1.19.601](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-cilium/rke2-cilium-1.19.601.tgz) |
| rke2-canal | [v3.32.1-build2026072200](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-canal/rke2-canal-v3.32.1-build2026072200.tgz) |
| rke2-calico | [v3.32.100](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-calico/rke2-calico-v3.32.100.tgz) |
| rke2-calico-crd | [v3.32.100](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-calico/rke2-calico-crd-v3.32.100.tgz) |
| rke2-coredns | [1.46.201](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-coredns/rke2-coredns-1.46.201.tgz) |
| rke2-ingress-nginx | [4.15.107](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-ingress-nginx/rke2-ingress-nginx-4.15.107.tgz) |
| rke2-metrics-server | [3.13.105](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-metrics-server/rke2-metrics-server-3.13.105.tgz) |
| rke2-multus | [v4.3.008](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-traefik/rke2-multus-v4.3.008.tgz) |
| rancher-vsphere-csi | [3.7.2-rancher700](https://github.com/rancher/rke2-charts/raw/main/assets/rancher-vsphere-csi/rancher-vsphere-csi-3.7.2-rancher700.tgz) |
| rancher-vsphere-cpi | [1.15.300](https://github.com/rancher/rke2-charts/raw/main/assets/rancher-vsphere-cpi/rancher-vsphere-cpi-1.15.300.tgz) |
| harvester-cloud-provider | [0.2.1400](https://github.com/rancher/rke2-charts/raw/main/assets/harvester-cloud-provider/harvester-cloud-provider-0.2.1400.tgz) |
| harvester-csi-driver | [0.1.3000](https://github.com/rancher/rke2-charts/raw/main/assets/harvester-cloud-provider/harvester-csi-driver-0.1.3000.tgz) |
| rke2-snapshot-controller | [4.2.008](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-snapshot-controller/rke2-snapshot-controller-4.2.008.tgz) |
| rke2-snapshot-controller-crd | [4.2.008](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-snapshot-controller/rke2-snapshot-controller-crd-4.2.008.tgz) |
| rke2-traefik | [40.1.009](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-traefik/rke2-traefik-40.1.009.tgz) |
| rke2-traefik-crd | [40.1.009](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-traefik/rke2-traefik-crd-40.1.009.tgz) |
...
| rke2-multus | [v4.2.418](https://github.com/rancher/rke2-charts/raw/main/assets/rke2-traefik/rke2-multus-v4.2.418.tgz) |
