...
# This linter script checks for necessary formatting and syntax in Markdown files.
# This helps ensure that the Markdown files we maintian can be converted to AsciiDoc
# without issues.
set -e
error=0
