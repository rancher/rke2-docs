...
If you want to generate new certificates and keys, instead of extending the validity of the existing certificates, use the <<_rotating_client_and_server_certificates_manually,`rotate`>> subcommand documented below.
