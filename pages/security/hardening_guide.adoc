...
* xref:./cis_self_assessment18.adoc[CIS Self-Assessment Guide v1.8] for RKE2 v1.27 and newer
* xref:./cis_self_assessment18.adoc[CIS Self-Assessment Guide v1.8] for RKE2 v1.26
* xref:./cis_self_assessment17.adoc[CIS Self-Assessment Guide v1.7] for RKE2 v1.25
