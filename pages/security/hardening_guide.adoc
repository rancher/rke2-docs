...
* xref:./cis_self_assessment112.adoc[CIS Self-Assessment Guide v1.12] for RKE2 v1.33 and newer
* xref:./cis_self_assessment111.adoc[CIS Self-Assessment Guide v1.11] for RKE2 v1.29-v1.32
* xref:./cis_self_assessment110.adoc[CIS Self-Assessment Guide v1.10] for RKE2 v1.28-v1.31
* xref:./cis_self_assessment19.adoc[CIS Self-Assessment Guide v1.9] for RKE2 v1.27-v1.29
...
. Configures the Pod Security Admission Controller to enforce restricted mode in all namespaces, with the exception of the `kube-system`,  `compliance-operator-system`, and `tigera-operator` namespaces.
...
For more information about the PSA configuration, see the default link:pod_security_standards.md#pod-security-standards[Pod Security Admission configurations]. +
For more information about Pod Security Standards, please refer to the https://kubernetes.io/docs/concepts/security/pod-security-standards/[official documentation].
...
See the xref:./pod_security_standards.adoc[Pod Security Policies] page for more details.
--
...
See the xref:./pod_security_policies.adoc[Pod Security Policies] page for more details.
--
...
*Remediation* +
This can be remediated by creating an `etcd` user and group as described <<_etcd_is_configured_properly,above>>.
