...
See the https://www.suse.com/suse-rke2/support-matrix/all-supported-versions/rke2-v1-34[RKE2 Support Matrix] for all the OS versions that have been validated with RKE2. In general, RKE2 should work on any Linux distribution that uses systemd and iptables.
...
[TIP]
====
If your node has NetworkManager installed and enabled, link:../known_issues.md#networkmanager[ensure that it is configured to ignore CNI-managed interfaces.]. If your node has Wicked installed and enabled, link:../known_issues.md#wicked[ensure that the forwarding sysctl config is enabled]
====
