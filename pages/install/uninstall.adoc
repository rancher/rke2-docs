...
[NOTE]
====
For cleaning a Rancher deployed RKE2 cluster see: https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/manage-clusters/clean-cluster-nodes#cleaning-up-nodes[Clean Cluster Nodes]
====
