...
. Copy the Hauler store content directly to the images directory. For RKE2, ensure the directory `/var/lib/rancher/rke2/agent/images/` exists on the node, then run:
...
. Follow the RKE2 <<_2_install_rke2,install instructions>>.
