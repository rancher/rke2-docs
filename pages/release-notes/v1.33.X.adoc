...
* Update to v1.33.12+rke2r2 https://github.com/rancher/rke2/pull/10443[(#10443)]
...
* Bump rke2-calico chart for network-unavailable toleration https://github.com/rancher/rke2/pull/10493[(#10493)]
