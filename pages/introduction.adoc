...
* Provides xref:./security/hardening_guide.adoc[defaults and configuration options] that allow clusters to pass the CIS Kubernetes Benchmark xref:security/cis_self_assessment112.adoc[v1.12] or xref:./security/cis_self_assessment111.adoc[v1.11] with minimal operator intervention
...
timeframe. To report a security vulnerability, please refer to our https://github.com/rancher/rke2/security/policy[Security Policy].
