...
[NOTE]
====
If you want to use Calico's eBPF dataplane with an HA control plane, refer to the xref:./cluster-loadbalancer.adoc[load balancer page].
====
