...
.ingress-nginx EOL
====
,https://kubernetes.io/blog/2025/11/11/ingress-nginx-retirement/[ingress-nginx becomes EOL] in March 2026. RKE2 still includes ingress-nginx in v1.36 but with a deprecated status. In v1.37 ingress-nginx is removed and unavailable for new clusters. No new images with fixes should be expected after March 2026. Please switch to Traefik or become a https://www.suse.com/products/rancher/[Rancher Prime user] for an extended support period.
====
