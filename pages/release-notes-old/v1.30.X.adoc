...
| link:v1.30.X.md#release-v13014rke2r4[v1.30.14+rke2r4]
| Sep 18 2025
...
== Release https://github.com/rancher/rke2/releases/tag/v1.30.14+rke2r4[v1.30.14+rke2r4]
...
* CNI Bumps for Aug 25 release https://github.com/rancher/rke2/pull/8689[(#8689)]
* Bump rancher vsphere csi to 3.3.1-rancher10 https://github.com/rancher/rke2/pull/8678[(#8678)]
* Update to cilium v1.18.000 https://github.com/rancher/rke2/pull/8719[(#8719)]
* Bump ingress-nginx to v1.12.4-hardened6 https://github.com/rancher/rke2/pull/8735[(#8735)]
* Update Kubernetes Metrics Server chart 3.13.000 https://github.com/rancher/rke2/pull/8744[(#8744)]
* Add prime ribs index upload and cache invalidation https://github.com/rancher/rke2/pull/8708[(#8708)]
* Publish prime-only assets https://github.com/rancher/rke2/pull/8754[(#8754)]
* Update K8s to v1.30.14 r3 https://github.com/rancher/rke2/pull/8770[(#8770)]
* Fix missing ECM config https://github.com/rancher/rke2/pull/8775[(#8775)]
* Fix uploader authentication https://github.com/rancher/rke2/pull/8780[(#8780)]
* Bump ingress-nginx to hardened7 https://github.com/rancher/rke2/pull/8792[(#8792)]
* Add REGISTRY env into package windows images step https://github.com/rancher/rke2/pull/8794[(#8794)]
* Remove docker login from publish-manifest-runtime https://github.com/rancher/rke2/pull/8800[(#8800)]
* Bump coredns chart and image (#8736) https://github.com/rancher/rke2/pull/8799[(#8799)]
* Bump runc 1.2.7 to fix CPU affinity issue https://github.com/rancher/rke2/pull/8852[(#8852)]
* Update kubernetes https://github.com/rancher/rke2/pull/8922[(#8922)]
...
* Update calico chart to v3.30.0 and Canal image https://github.com/rancher/rke2/pull/8204[(#8204)]
